...
const ERC20ABI = require('./token-swap/abi/ERC20ABI.json');
...
// Only Kyber Network Coins
    ...
    constructor(
        ...
        // this.initBancorTokens();
        // this.initKyberTokens();
    ...
    //     do {
    //
    //         result = await this.http.get('https://api.bancor.network/0.1/currencies?limit=100&skip=' + skip).toPromise();
    //
    //         if (!result.data) {
    //             continue;
    //         }
    //
    //         for (let object of result.data.currencies.page) {
    //
    //             for (let details of object.details) {
    //
    //                 if (
    //                     details.blockchain.type === 'ethereum' &&
    //                     details.stage === 'traded' &&
    //                     (
    //                         details.type === 'standard' ||
    //                         details.type === 'native' ||
    //                         details.subType === 'liquid' ||
    //                         details.subType === 'smart'
    //                     )
    //                 ) {
    //
    //                     if (object.code) {
    //                         this.tokens[object.code] = {
    //                             symbol: object.code,
    //                             name: object.name,
    //                             icon: object.primaryCommunityImageName,
    //                             decimals: details.decimals,
    //                             address: details.blockchainId
    //                         };
    //                     }
    //                 }
    //             }
    ...
    //
    //         skip += 100;
    //     } while (result.data.currencies.page.length);
    //
    ...
    // async initKyberTokens() {
    //
    //     const response = await this.http.get('https://api.kyber.network/currencies').toPromise();
    //     const result = response['data'];
    //
    //     for (let i = 0; i < result.length; i++) {
    //
    //         if (!this.tokens[result[i].symbol]) {
    //
    //             this.kyberTokens[result[i].symbol] = {
